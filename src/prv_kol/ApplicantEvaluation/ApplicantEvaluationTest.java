package prv_kol.ApplicantEvaluation;
...
class EvaluatorBuilder {
    ...
    static Evaluator MoreCreditEvaluator = applicant ->  applicant.getCreditScore() >= 500;
    ...
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluation {
        switch (type){
            ...
            case MORE_CREDIT_SCORE: return MoreCreditEvaluator;
            case NO_CRIMINAL_RECORD_AND_MORE_CREDIT_SCORE:
                return new ComplexEvaluator(NoCriminalRecordEvaluator, MoreCreditEvaluator);
            ...
            case MORE_EXPERIENCE_AND_MORE_CREDIT_SCORE:
                return new ComplexEvaluator(MoreExperienceEvaluator, MoreCreditEvaluator);
            case INVALID:
