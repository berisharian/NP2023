...
class PausedState extends CallState{
    public PausedState(CallState call) {
        super(call);
    }
...
class IdleState extends CallState{
    public IdleState(CallState call) {
        super(call);
    }
...
class TelcoApp{
    ...
    public void printCall(Call c, String phoneNumber){
        ...
        System.out.println(String.format("%s %s %d %s %s",
                type, otherPhoneNumber, c.getStart(), end, DurationConverter.convert(c.getTotalDuration())));
    }
    ...
    public void printCallsDuration() {
        ...
        result.entrySet().stream()
                ...
                .forEach(entry-> System.out.printf("%s : %s%n",
                        entry.getKey(), DurationConverter.convert(entry.getValue())));
