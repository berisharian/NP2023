...
class Cluster <T extends IIdentifier>{
    Map<Long, T> clusters = new HashMap<>();
    ...
    public void near(long id, int top){
        ...
        clusters.entrySet().stream()
                ...
                .forEach(x-> System.out.println(indx.getAndIncrement() + ". " + format(x.getKey(), x.getValue(), id)));
    }
    public String format(long id, T element, long targetId){
